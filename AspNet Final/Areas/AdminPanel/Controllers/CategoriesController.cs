...
namespace AspNet_Final.Areas.AdminPanel.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Deleted,IsDeleted")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Deleted,IsDeleted")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
